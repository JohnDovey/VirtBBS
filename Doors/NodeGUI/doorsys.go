...
// SysopSecurityMin is the minimum DOOR.SYS security level treated as sysop.
// VirtBBS sysop accounts are created at 110; conference/sysop gates use 100+.
const SysopSecurityMin = 100
...
// IsSysop reports whether the caller may perform import/admin actions.
func (s *DoorSession) IsSysop() bool {
	return s != nil && s.SecurityLevel >= SysopSecurityMin
}

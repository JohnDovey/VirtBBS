...
| [MRC.md](docs/MRC.md) | Built-in Multi-Relay Chat hub, terminal + web client |
...
| **MRC Chat** | Built-in Multi-Relay Chat hub; Telnet/SSH `[A]` + web `/mrc`; Admin → MRC — see [docs/MRC.md](docs/MRC.md) |

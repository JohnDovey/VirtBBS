...
func (s *Server) ListenAndServe() error {
	...
	mux.HandleFunc("/admin/fido/taglines", s.handleAdminFidoTaglines)
	mux.HandleFunc("/admin/fido/tools", s.handleAdminFidoTools)
	mux.HandleFunc("/admin/fido/freq-stats", s.handleAPIAdminFidoFreqStats)
	...
	mux.HandleFunc("/ansiart", s.handleAnsiArt)
	mux.HandleFunc("/ansiart/convert", s.handleAnsiArtConvert)
	mux.HandleFunc("/ansiart/view", s.handleAnsiArtView)
	mux.HandleFunc("/ansiart/download", s.handleAnsiArtDownload)

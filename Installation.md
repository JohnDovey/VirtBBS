...
From the `releases/0.2.0/` package, copy the following into your installation directory:
...
```
2026/06/25 12:00:00 VirtBBS 0.2.0 starting
...
This guide covers VirtBBS **0.2.0**.
